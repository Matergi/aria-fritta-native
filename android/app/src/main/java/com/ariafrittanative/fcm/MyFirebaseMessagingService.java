...
import com.ariafrittanative.MainActivity;
import com.ariafrittanative.R;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getNotification() != null) {
            ...
            sendNotification(remoteMessage.getData().get("pinpoint.notification.title") + " - " + remoteMessage.getData().get("pinpoint.notification.body"), remoteMessage.getData());
        }
    ...
    private void sendNotification(String messageBody, Map data) {
        ...
        String channelId = "aria-fritta";//getString(R.string.default_notification_channel_id);
